...
<?php
    ...
    else
    {
        ...
        // Configure upload directory and allowed file types
            ...
            {
                $sql = mysqli_query($conn, "INSERT INTO property (latitude,longitude, category, description, images, area) VALUES ($latitude,$longitude, '$for', '$description', '$imagesStr', $area)");
            ...
            {
                $sql = mysqli_query($conn, "INSERT INTO property (latitude,longitude, category, description, images, area,age) VALUES ($latitude,$longitude, '$for', '$description', '$imagesStr', $area,$age)");
                $last_id = mysqli_insert_id($conn);
                if(mysqli_error($conn)) {
                    set_alert(mysqli_error($conn), "danger");
                }
